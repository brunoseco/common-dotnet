...
namespace BoletoNet
{
    public abstract class AbstractBanco
    {
        ...
        {
            return boleto.Remessa != null && !string.IsNullOrEmpty(boleto.Remessa.CodigoOcorrencia) ? Utils.FormatCode(boleto.Remessa.CodigoOcorrencia, 2) : Utils.FormatCode((01).ToString(), 2);
        }
        /// <summary>
        ...
        /// <summary>
        /// Gera registros de detalhe tipo 2 do arquivo remessa
        /// </summary>
        public virtual string GerarDetalheRemessaTipo2(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            string _remessa = "";
            return _remessa;
        }
        /// <summary>
        /// Gera registros de detalhe tipo 5 do arquivo remessa
        /// </summary>
        public virtual string GerarDetalheRemessaTipo5(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            string _remessa = "";
            return _remessa;
        }
        ...
        /// Gera os registros de Trailer do arquivo de remessa
        /// </summary>
        public virtual string GerarTrailerRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo, Cedente cedente, decimal vltitulostotal)
        {
            string _trailer = "";
            return _trailer;
        }
        ...
        public virtual DetalheRetorno LerDetalheRetorno7CNAB400(string registro)
        {
