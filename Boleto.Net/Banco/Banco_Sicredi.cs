    ...
    internal class Banco_Sicredi : AbstractBanco, IBanco
    {
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            ...
            if (boleto.NossoNumero.Length > 5)
                throw new NotImplementedException("Nosso número inválido, excedeu o limite de 6 caracteres.");
            ...
            if (string.IsNullOrEmpty(codigoCedente))
                throw new NotImplementedException("Código do cedente deve ser informado, " + infoFormatoCodigoCedente);
                ...
                throw new NotImplementedException("Código do cedente deve estar no " + infoFormatoCodigoCedente);

            if (string.IsNullOrEmpty(boleto.Carteira))
                throw new NotImplementedException("Tipo de carteira é obrigatório.");
            else if (!CarteiraValida(boleto.Carteira))
                throw new NotImplementedException("Carteira informada é inválida.");

            FormataCodigoBarra(boleto);

            if (boleto.CodigoBarra.Codigo.Length != 44)
                throw new NotImplementedException("Código de barras é inválido");
        ...
        public override DetalheRetorno LerDetalheRetornoCNAB400(string registro)
        {
            try
            {
                ...
                detalhe.NossoNumero = nossonumero.Substring(0, nossonumero.Length - 1); //Nosso Número sem o DV!
