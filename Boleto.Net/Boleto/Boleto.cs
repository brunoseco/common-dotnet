...
namespace BoletoNet
{
    ...
    public class Boleto
    {
        ...
        private string _codigoOcorrencia = "01"; //utilizado para definir o codigo de ocorrencia ao gerar o arquivo de remessa (detalhes nos manuais)
        ...
        private bool _bancoGeraBoleto;
        private bool _baixarAposXDias;
        ...
        #region Properties
        /// <summary> 
        /// Define se é o Banco ou o Cliente que emite o boleto
        /// </summary>
        public bool BancoGeraBoleto
        {
            get { return _bancoGeraBoleto; }
            set { this._bancoGeraBoleto = value; }
        }
        /// <summary> 
        ...
        /// <summary> 
        /// Retorna se o boleto deve ser baixado após x dias na remessa
        /// </summary>
        public bool BaixarAposXDias
        {
            get { return _baixarAposXDias; }
            set { this._baixarAposXDias = value; }
        }
        /// <summary> 
        /// Retorna se o boleto é segunda via
        /// </summary>
        public bool SegundaVia
        {
            get { return _segundaVia; }
            set { this._segundaVia = value; }
        }
        /// <summary> 
        /// Retorna o Codigo de Ocorrencia do Arquivo de Remessa
        /// </summary>
        public string CodigoOcorrencia
        {
            get { return _codigoOcorrencia; }
            set { this._codigoOcorrencia = value; }
        }
        /// <summary> 
        ...
        public void FormataCampos()
        {
            ...
            {
                throw new Exception("Erro durante a formatação dos campos. " + ex.Message, ex);
            }
        }
    }
}
