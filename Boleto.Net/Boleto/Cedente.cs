...
namespace BoletoNet
{
    ...
    public class Cedente
    {
        ...
        private string _convenio = "0";
        private string _cpfcnpj;
        private string _nome;
        private ContaBancaria _contaBancaria;
        private int _codigoTransmissao = 0;
        ...
        public string CPFCNPJ
        {
            ...
            set
            {
                ...
                if (o == null || (o.Length != 11 && o.Length != 14))
                    throw new ArgumentException("O CPF/CNPJ do cedente é inválido. Utilize 11 dígitos para CPF ou 14 para CPNJ.");
