...
namespace BoletoNet
{
    ...
    public class EspecieDocumento_Nordeste : AbstractEspecieDocumento, IEspecieDocumento
    {
        ...
        public static EspeciesDocumento CarregaTodas()
        {
            ...
            foreach (EnumEspecieDocumento_Nordeste item in Enum.GetValues(typeof(EnumEspecieDocumento_Nordeste)))
                especiesDocumento.Add(new EspecieDocumento_Nordeste(ed.getCodigoEspecieByEnum(item)));
