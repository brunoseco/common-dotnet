...
namespace Common.Boleto
{
    public class BoletoCobrancaPdf : BoletoCobranca
    {
        ...
        private PdfRenderingResult Linha6CarneDireita(BoletoNet.BoletoBancario bb, PdfPage page, ref PdfRenderingResult pdf, PdfFont font, ref Color color, int x, int y)
        {
            ...
            {
                PdfTextElement pagador = new PdfTextElement(x2, y2, item, font, color);
        ...
        {
            font.Size = 06;
            PdfTextElement localpagamento = new PdfTextElement(x + 112, y + 35, bb.Boleto.LocalPagamento, font, color);
        ...
        private PdfRenderingResult MontaCarneEsquerda(BoletoNet.BoletoBancario bb, string pathArquivosBoletoNet, PdfPage page, PdfRenderingResult pdf, PdfFont font, Color color, int x, int y)
        {
            ...
            var yLogo = y + 15;
            var yCedente = y + 80;
            if (this.BancoDoBrasilExcecao(bb.Boleto.Banco.Codigo, bb.Boleto.Carteira))
            {
                yLogo -= 13;
                yCedente -= 25;
            }

            if (bb.Boleto.Banco.Codigo == (int)EBanco.Banrisul)
            {
                yLogo -= 13;
                yCedente -= 25;
            }

            PdfImageElement logo = new PdfImageElement(x + 1, yLogo, 106, 25, imgBanco);
            pdf = page.Add(logo);

            x = x + 5;

            font.Size = 07;
            PdfTextElement cedente = new PdfTextElement(x, yCedente, 100, bb.ExibeNomeCedente.Replace("<br />", "\n"), font, color);
            ...
            PdfTextElement numerodocumento = new PdfTextElement(x, y + 169, 100, bb.ExibeNossoNumero, font, color);
            pdf = page.Add(numerodocumento);
        ...
        private PdfRenderingResult BackgroundCarne(BoletoNet.BoletoBancario bb, PdfPage page, string pathArquivosBoletoNet, int x, int y)
        {
            ...
            else if (this.BancoDoBrasilExcecao(bb.Boleto.Banco.Codigo, bb.Boleto.Carteira))
        ...
        private bool BancoDoBrasilExcecao(int banco, string carteira)
        {
            return banco == (int)EBanco.BancoDoBrasil &&
                (carteira.Equals("17-019") ||
                carteira.Equals("17-035") ||
                carteira.Equals("17-051") ||
                carteira.Equals("17-027") ||
                carteira.Equals("18-019"));
        }
        ...
        private PdfRenderingResult MakePages(PdfDocument doc, BoletoNet.BoletoBancario bb, string pathArquivosBoletoNet, PdfPage page, BoletoCobranca boletoCobranca)
        {
            ...
            if (boletoCobranca.Sacado.Alunos.IsAny())
