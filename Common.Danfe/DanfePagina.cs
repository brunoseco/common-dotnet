...
namespace Common.Danfe
{
    internal class DanfePagina
    {
        ...
        {
            Gfx.DrawString("Impresso com Common.Danfe", RetanguloCreditos, Danfe.EstiloPadrao.CriarFonteItalico(6), AlinhamentoHorizontal.Direita);
        }
