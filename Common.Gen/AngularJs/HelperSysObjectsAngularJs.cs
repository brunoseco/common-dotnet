...
namespace Common.Gen
{
    public class HelperSysObjectsAngularJs : HelperSysObjectsBaseFront
    {
        ...
        private void ExecuteTemplateAngularHomeView(TableInfo tableInfo, Context configContext)
        {
            ...
            using (var stream = new StreamWriter(pathOutput)) { stream.Write(classBuilderModal); }
        }
        ...
        private void ExecuteTemplateAngularInitApp(TableInfo tableInfo, Context configContext)
        {
            ...
            var pathOutputApp = PathOutput.PathOutputAngularApp(tableInfo, configContext);
            ...
            using (var stream = new StreamWriter(pathOutputApp)) { stream.Write(classBuilderModal); }
        }
        ...
        private void ExecuteTemplateAngularModalCreate(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            var pathOutputModal = PathOutput.PathOutputAngularModalCreate(tableInfo, configContext);
            if (File.Exists(pathOutputModal))
                return;
            ...
            using (var stream = new StreamWriter(pathOutputModal)) { stream.Write(classBuilderModal); }
        }
        ...
        private void ExecuteTemplateAngularModalEdit(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            var pathOutputModal = PathOutput.PathOutputAngularModalEdit(tableInfo, configContext);
            if (File.Exists(pathOutputModal))
                return;
        ...
        private void ExecuteTemplateAngularFormCreate(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            var pathOutputModal = PathOutput.PathOutputAngularFormCreate(tableInfo, configContext);
        ...
        private void ExecuteTemplateAngularFormEdit(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            var pathOutputModal = PathOutput.PathOutputAngularFormEdit(tableInfo, configContext);
        ...
        private void ExecuteTemplateAngularEditInPage(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            using (var stream = new StreamWriter(pathOutput)) { stream.Write(classBuilderEditInPage); }
        }
        private void ExecuteTemplateAngularCreateInPage(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            using (var stream = new StreamWriter(pathOutput)) { stream.Write(classBuilderCreateInPage); }
        }
        private void ExecuteTemplateAngularDetails(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            using (var stream = new StreamWriter(pathOutput)) { stream.Write(classBuilderDetails); }
        }
        ...
        private void ExecuteTemplateAngularDetailsFields(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            var pathOutputDetails = PathOutput.PathOutputAngularDetailsField(tableInfo, configContext);
                ...
                foreach (var item in infos)
                {
                    ...
                    if (IsPropertyInstance(tableInfo, item.PropertyName))
                    {
                        ...
                        itemForm = itemForm.Replace("<#type#>", "propertyInstance")
                            .Replace("<#moreattr#>", string.Format("{0}= \"{1}\" {2}= \"{3}\" ", "bind-property-name", propertyName, "bind-releted-class", PropertyInstance(tableInfo, item.PropertyName)));
                    }
            ...
            using (var stream = new StreamWriter(pathOutputDetails)) { stream.Write(classBuilderDetailsFields); }
        }
        ...
        private void ExecuteTemplateAngularView(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            using (var stream = new StreamWriter(pathOutput)) { stream.Write(classBuilderView); }
        }
        ...
        private void ExecuteTemplateAngularViewFilters(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            var pathOutputView = PathOutput.PathOutputAngularViewFilters(tableInfo, configContext);
            ...
            using (var stream = new StreamWriter(pathOutputView)) { stream.Write(classBuilderView); }
        }
        ...
        private void ExecuteTemplateAngularViewGrid(TableInfo tableInfo, Context configContext, IEnumerable<Info> infos)
        {
            ...
            var pathOutputView = PathOutput.PathOutputAngularViewGrid(tableInfo, configContext);
        ...
        private void ExecuteTemplateAngularController(TableInfo tableInfo, Context configContext)
        {
            ...
            var pathOutputController = PathOutput.PathOutputAngularController(tableInfo, configContext);
        ...
        private void ExecuteTemplateAngularControllerCustom(TableInfo tableInfo, Context configContext)
        {
            ...
            var pathOutputControllerCustom = PathOutput.PathOutputAngularControllerCustom(tableInfo, configContext);
            ...
            using (var stream = new StreamWriter(pathOutputControllerCustom)) { stream.Write(classBuilderControllerCustom); }
        }
