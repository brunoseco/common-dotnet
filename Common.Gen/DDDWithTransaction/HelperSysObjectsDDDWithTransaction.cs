...
namespace Common.Gen
{
    public class HelperSysObjectsDDDWithTransaction : HelperSysObjectsBaseBack
    {
        ...
        {
            if (configExecutetemplate.ConfigContext.Arquiteture == ArquitetureType.TransactionScript)
                return this._transaction.TransformFieldPropertyInstance(configExecutetemplate, info, propertyName, textTemplate);

            return this._ddd.TransformFieldPropertyInstance(configExecutetemplate, info, propertyName, textTemplate);
        }
