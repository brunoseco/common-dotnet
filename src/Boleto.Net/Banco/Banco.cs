...
namespace BoletoNet
{
    public class Banco : AbstractBanco, IBanco
    {
        ...
        public override void FormataCodigoBarra(Boleto boleto)
        {
            ...
            {
                throw new Exception("Erro durante a formatação do código de barra. " + ex.Message, ex);
            }
        }
        ...
        public override string GerarDetalheRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            ...
            {
                throw new Exception("Erro durante a geração dos registros de DETALHE do arquivo de REMESSA.", ex.InnerException);
            }
        }
        ...
        public override string GerarDetalheRemessaTipo2(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                return _IBanco.GerarDetalheRemessaTipo2(boleto, numeroRegistro, tipoArquivo);
            }
            catch (Exception ex)
            {
                throw new Exception("Erro durante a geração dos registros de DETALHE do arquivo de REMESSA.", ex.InnerException);
        ...
        public override string GerarDetalheRemessaTipo5(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                return _IBanco.GerarDetalheRemessaTipo5(boleto, numeroRegistro, tipoArquivo);
            }
            catch (Exception ex)
            {
                throw new Exception("Erro durante a geração dos registros de DETALHE do arquivo de REMESSA.", ex.InnerException);
        ...
        {
            return _IBanco.LerDetalheRetorno7CNAB400(registro);
        }
