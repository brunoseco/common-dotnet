...
namespace BoletoNet
{
    ...
    internal class Banco_Sicoob : AbstractBanco, IBanco
    {
        ...
        private static string GerarHeaderRemessaCNAB400(Cedente cedente, int numeroArquivoRemessa)
        {
            //Variaveis
            ...
            try
            {
                ...
                _header.Append(Utils.FitStringLength(numeroArquivoRemessa.ToString(), 7, 7, '0', 0, true, true, true)); //Posição 101 a 107
        ...
        public string GerarHeaderRemessaCNAB240(Cedente cedente, int numeroArquivoRemessa)
        {
            try
            {
                var dvAgencia = cedente.ContaBancaria.DigitoAgencia ?? "0";
                ...
                header += Utils.FitStringLength(numeroArquivoRemessa.ToString(), 6, 6, '0', 0, true, true, true);            //Nº sequencial do arquivo                  158-163
        ...
        private string GerarHeaderLoteRemessaCNAB240(Cedente cedente, int numeroArquivoRemessa)
        {
            try
            {
                ...
                header += Utils.FormatCode(cedente.CPFCNPJ, "0", 15, true);                         //Nº inscrição empresa                          019-033
                header += Utils.FormatCode("", " ", 20, false);                                     //Codigo convênio Sicoob: Brancos               034-052
                header += Utils.FormatCode(cedente.ContaBancaria.Agencia, "0", 5, true);            //Prefixo da Cooperativa                        053-057
                header += Utils.FormatCode(dvAgencia, "0", 1);                                      //Digito da Cooperativa                         058-058
                header += Utils.FormatCode(cedente.ContaBancaria.Conta, "0", 12, true);             //Conta Corrente                                059-070
                header += Utils.FormatCode(cedente.ContaBancaria.DigitoConta, "0", 1);              //Digito da Conta Corrente                      071-071  
        ...
        public override string GerarDetalheSegmentoPRemessa(Boleto boleto, int numeroRegistro, string codigoTransmissao)
        {
            try
            {
                var dvAgencia = boleto.Cedente.ContaBancaria.DigitoAgencia ?? "0";
                string _segmentoP;
                ...
                this.FormataNossoNumero(boleto);
                _segmentoP += Utils.FitStringLength(boleto.NossoNumero.Replace("-", ""), 10, 10, '0', 0, true, true, true);
                ...
                var carteira = boleto.Carteira.Length > 1 ? boleto.Carteira[1] : boleto.Carteira[0];
                _segmentoP += Utils.FitStringLength(carteira.ToString(), 1, 1, '0', 0, true, true, true);
        ...
        public override DetalheSegmentoTRetornoCNAB240 LerDetalheSegmentoTRetornoCNAB240(string registro)
        {
            try
            {
                ...
                segmentoT.NossoNumero = registro.Substring(37, 9);
                ...
                this.ConfiguraCodigoRejeicao(segmentoT);
        ...
        private void ConfiguraCodigoRejeicao(DetalheSegmentoTRetornoCNAB240 segmentoT)
        {
            ...
            {
                segmentoT.CodigoRejeicao1 = new CodigoRejeicao(segmentoT.CodigoBanco, segmentoT.IdRejeicao1);
            }
            ...
            {
                segmentoT.CodigoRejeicao2 = new CodigoRejeicao(segmentoT.CodigoBanco, segmentoT.IdRejeicao2);
            }
            ...
            {
                segmentoT.CodigoRejeicao5 = new CodigoRejeicao(segmentoT.CodigoBanco, segmentoT.IdRejeicao5);
            }
        }
