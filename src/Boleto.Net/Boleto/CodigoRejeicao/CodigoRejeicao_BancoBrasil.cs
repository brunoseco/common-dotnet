...
namespace BoletoNet
{
    ...
    public class CodigoRejeicao_BancoBrasil : AbstractCodigoRejeicao, ICodigoRejeicao
    {
        ...
        public CodigoRejeicao_BancoBrasil(string codigo)
        {
            try
            {
        ...
        private void carregar(string codigo)
        {
            try
            {
                ...
                var _codigo = (EnumCodigoRejeicao_BancoBrasil)Convert.ToInt32(codigo);
                ...
                switch (_codigo)
                {
                    ...
                    case EnumCodigoRejeicao_BancoBrasil.TipoNumeroInscricaoCedenteInvalidos:
                        ...
                        this.Descricao = "Tipo/Número de inscrição do cedente inválidos";
                        break;
