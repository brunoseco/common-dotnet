    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        public string ExibeNomeCedente
        {
            get
            {
                ...
                if (this.Boleto.Banco.Codigo == 399 || // HSBC
                    this.Boleto.Banco.Codigo == 001) //BB
                    nomeCedente += " - CNPJ: " + this.Cedente.CPFCNPJ;

                if (this.Boleto.Banco.Codigo == 001) // BB
            ...
            get
            {
                ...
                if (!this.Cedente.DigitoCedente.Equals(-1))
                {
                    ...
                    switch (Boleto.Banco.Codigo)
                    {
                        case 756:
                            ...
                            break;
                        case 748:
                            agenciaCodigoCedente = string.Format("{0}.{1}.{2}", this.Cedente.Codigo.Substring(0, 4), this.Cedente.Codigo.Substring(4, 2), this.Cedente.Codigo.Substring(6, this.Cedente.Codigo.Length - 6));
                            break;
                        case 104:
                            {
                ...
                else
                {
                    if (Boleto.Banco.Codigo == 033)
                    {
                        ...
                        agenciaCodigoCedente = string.Format("{0}-{1} / {2}-{3}", this.Cedente.ContaBancaria.Agencia, this.Cedente.ContaBancaria.DigitoAgencia, Utils.FormatCode(this.Cedente.ContaBancaria.Conta, 6), this.Cedente.ContaBancaria.DigitoConta);
                    else if (Boleto.Banco.Codigo == 4)
                        agenciaCodigoCedente = string.Format("{0}/{1}-{2}", this.Cedente.ContaBancaria.Agencia, this.Cedente.ContaBancaria.Conta, this.Cedente.ContaBancaria.DigitoConta);
                    else
        ...
        public string ExibeNossoNumero
        {
            get
            {
                ...
                if (this.Boleto.Banco.Codigo == 1 && (this.Boleto.Carteira.Equals("17-019") || this.Boleto.Carteira.Equals("17-051") || this.Boleto.Carteira.Equals("18-019")))
        ...
        public string GeraHtmlReciboCedente()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (Boleto.Banco.Codigo == 1 && (Boleto.Carteira.Equals("17-019") || Boleto.Carteira.Equals("17-051") || Boleto.Carteira.Equals("18-019")))
                        html.Replace("Carteira /", "");
