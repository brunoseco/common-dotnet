namespace BoletoNet
{
    ...
    internal enum ECodigoOcorrenciaNordeste400
    {
        Entrada_Confirmada = 02,
        Alteração = 04,
        Liquidação_Normal = 06,
        Pagamento_por_Conta = 07,
        Pagamento_por_Cartório = 08,
        Baixa_Simples = 09,
        ...
        Baixa_Automática = 15,
        Alteração_Depositária = 18,
        Confirmação_Protesto = 19,
        Confirmação_SustarProtesto = 20,
        Alteração_informações_de_Controle_da_Empresa = 21,
        Alteração_Seu_Número = 22,
