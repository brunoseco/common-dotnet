...
namespace Common.Boleto
{
    public class ArquivoRetorno
    {
        ...
        public List<ArquivoRetornoDetalhe> CollectionArquivoRetornoDetalhe { get; set; }
        ...
        public ArquivoRetorno ImportarArquivoRetorno(ELayoutArquivoRetorno layout, int codigoBanco, Stream arquivoRetornostream)
        {
            ...
            arquivoRetorno.CollectionArquivoRetornoDetalhe = new List<ArquivoRetornoDetalhe>();
        ...
        private static void PreparaLeituraCNAB400(ArquivoRetorno arquivoRetorno, Stream arquivo, BoletoNet.Banco banco)
        {
            ...
            {
                var isNumber = Regex.IsMatch(detalhe.NossoNumero, @"^\d+$");
                if (isNumber)
                {
                    arquivoRetorno.CollectionArquivoRetornoDetalhe.Add(new ArquivoRetornoDetalhe
                    {
        ...
        private static void PreparaLeituraCNAB240(ArquivoRetorno arquivoRetorno, Stream arquivo, BoletoNet.Banco banco)
        {
            ...
            {
                if (Int64.TryParse(detalhe.SegmentoT.NossoNumero, out nossoNumero))
                {
                    arquivoRetorno.CollectionArquivoRetornoDetalhe.Add(new ArquivoRetornoDetalhe
                    {
                        ...
                        DataVencimento = detalhe.SegmentoT.DataVencimento,
