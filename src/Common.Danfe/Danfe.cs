...
using Common.Danfe.Blocos;
using org.pdfclown.documents;
using org.pdfclown.documents.contents.fonts;
using org.pdfclown.files;
using Common.Danfe.Modelo;
...
namespace Common.Danfe
{
    public class Danfe : IDisposable
    {
        ...
        private void AdicionarMetadata()
        {
            ...
            info.Creator = String.Format("{0} {1} - {2}", "Common.Danfe", System.Reflection.Assembly.GetExecutingAssembly().GetName().Version, "https://github.com/SilverCard/Common.Danfe");
